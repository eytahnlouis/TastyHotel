...
import java.awt.*;
 ...
 public class VueChoisirPossibiliteReservation extends JFrame {
    ...
    public VueChoisirPossibiliteReservation(Hotel h1) {
        ...
        add(panelBoutons);
        setVisible(true);
        buttonAjouter.addActionListener(e -> new VueAjoutReservation(h1));
        buttonSupprimer.addActionListener(e -> new VueSupprimerReservation(h1));
        buttonConsulter.addActionListener(e -> new VueListeReservation(h1));
    }
